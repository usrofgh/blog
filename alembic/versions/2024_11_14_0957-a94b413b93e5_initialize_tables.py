...
Revision ID: a94b413b93e5
Revises: 
Create Date: 2024-11-14 09:57:18.854344
...
def upgrade() -> None:
    ...
    op.create_table('connections_history',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('connections_history')
